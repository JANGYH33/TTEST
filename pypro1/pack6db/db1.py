...
# 개인용 DBMS : sqlite <- 파이썬 설치시 자동 등록, 기본 모듈(라이브러리)로 제공
...
try:
    ...
    cur.execute("insert into friends(name, phone, addr) values('한국인','111-1111','강남구 역삼동')")
    cur.execute("insert into friends values('이상한','222-1111','강남구 서초동')")
